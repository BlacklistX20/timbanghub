  ...
  <div class="max-w-7xl mx-auto pl-4 pb-10 pr-4 md:pr-0">
    <div class="flex flex-col mb-8">
      ...
      <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <button v-if="hasActionAccess" @click="isModalOpen = true" class="w-full sm:w-auto bg-green-600 hover:bg-green-700 text-white font-semibold py-2.5 px-5 rounded-lg flex items-center justify-center transition-colors shadow-lg">
