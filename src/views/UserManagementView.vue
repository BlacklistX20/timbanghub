    ...
    <div class="bg-gray-800 rounded-2xl shadow-lg border border-gray-700 overflow-x-auto">
      <table class="w-full text-left border-collapse min-w-[1000px]">
        ...
        <tbody class="text-gray-300 text-sm">
          <tr v-for="(user, index) in users" :key="user._id" class="hover:bg-gray-700/50 transition-colors">
            ...
            <td class="p-4 border-b border-gray-700 text-center">
              <div class="flex items-center justify-center space-x-3">
                ...
                <button @click="handleDelete(user._id, user.username)" class="text-red-400 hover:text-red-300 transition-colors" title="Hapus Akun">
